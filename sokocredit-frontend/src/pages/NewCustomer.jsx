...
const initialForm = { name: '', phone: '+254', nationalId: '', kraPin: '', market: 'Wakulima Market (Marikiti)', stall: '', commodity: 'Vegetables & Fruits (Mama Mboga)', yearsOperating: '3', dailyTurnover: '', dailyProfit: '', chama: 'No Chama / Individual Borrower', nextOfKin: '', relationship: 'Spouse', nextOfKinPhone: '+254', appraisalNotes: '' };
...
export default function NewCustomer() {
  ...
  const submit = async (event) => {
    ...
    // NOTE: kraPin, dailyTurnover/Profit, chama, and next-of-kin fields are
    // captured here but the Customer backend model doesn't have columns for
    // them yet — they're not persisted. Whoever owns that model can extend
    // it and this payload together once those fields are prioritized.
