...
export default function TopBar({ title, subtitle }) {
  ...
  const [notifications, setNotifications] = useState(() => getNotifications(role, user?.id));
  ...
  useEffect(() => {
    const refresh = () => setNotifications(getNotifications(role, user?.id));
