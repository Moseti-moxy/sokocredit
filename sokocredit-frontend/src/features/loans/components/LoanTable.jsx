...
export default function LoanTable({ loans, onSelect }) {
  return <div className="app-surface overflow-hidden">
    <div className="hidden grid-cols-[1.5fr_.8fr_1.15fr_1fr_.9fr] items-center gap-3.5 bg-brand-50 px-4 py-4 text-[11px] font-semibold uppercase tracking-[.4px] text-slate-500 md:grid"><span>Customer</span><span>Amount</span><span>Progress</span><span>Status</span><span>Next Due Date</span></div>
