...
REQUIRED_FIELDS = ('fullName', 'phoneNumber', 'businessName')
...
def create_customer():
    ...
    customer = Customer(full_name=values['fullName'], phone_number=values['phoneNumber'], business_name=values['businessName'])
    try:
